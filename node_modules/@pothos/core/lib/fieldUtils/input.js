...
var _inputField = _interopRequireDefault(require("../refs/input-field"));
...
class InputFieldBuilder {
   ...
   */ field(options) {
        ...
        this.builder.configStore.addFieldRef(ref, options.type, {}, (name, parentField, typeConfig)=>({
                ...
                type: (0, _utils).inputTypeFromParam(options.type, this.builder.configStore, (_required = options.required) !== null && _required !== void 0 ? _required : this.builder.defaultInputFieldRequiredness),
...
exports.default = InputFieldBuilder;
