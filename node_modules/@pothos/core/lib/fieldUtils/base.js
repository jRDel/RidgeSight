...
var _field = _interopRequireDefault(require("../refs/field"));
...
class BaseFieldUtil {
    ...
    options) {
        const ref1 = new _field.default(this.kind, this.typename);
        var _args;
        this.builder.configStore.addFieldRef(ref1, options.type, (_args = options.args) !== null && _args !== void 0 ? _args : {}, (name, parentField, typeConfig)=>{
            var ref;
            const args = {};
            if (options.args) {
