...
export function run(opts) {
    ...
    const json = JSON.parse(fs.readFileSync(path.join(opts.rootDir, "package.json")).toString());
    ...
    for (const pkg of [
        ...
        if (!opts.verbose)
            console.log(chalk.gray("Updating", pkg, "to", version));
        manager.add({
            cwd: opts.rootDir,
    ...
    if (cdkV1deps.length) {
        ...
        console.log("");
        console.log(`More details on upgrading to CDK v2: https://github.com/serverless-stack/serverless-stack/releases/tag/v0.59.0`);
